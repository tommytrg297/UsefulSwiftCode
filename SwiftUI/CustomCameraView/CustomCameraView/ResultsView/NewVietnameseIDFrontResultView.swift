//
//  NewVietnameseIDFrontResultView.swift
//  CustomCameraView
//
...
struct NewVietnameseIDFrontResultView: View {
...
struct NewVietnameseIDFrontResultView_Previews: PreviewProvider {
    static var previews: some View {
        NewVietnameseIDFrontResultView(image: .constant(UIImage(systemName: "star")!),data: NewVietnameseIDFront.cccdPhat.data[0])
    }
}
